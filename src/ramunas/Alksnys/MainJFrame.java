...
public class MainJFrame extends JFrame {
	...
	private void configJScroll(){
		fileChoserBar =  new JScrollPane(fileChooserLog,
				JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED, JScrollPane.HORIZONTAL_SCROLLBAR_NEVER);	
		letterContBar  =  new JScrollPane(letterContArea,
				JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED, JScrollPane.HORIZONTAL_SCROLLBAR_NEVER);	
		proccessBar  =  new JScrollPane(proccessLog,
				JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED, JScrollPane.HORIZONTAL_SCROLLBAR_NEVER);	
	...
	private void configMainPanel() {
		...
		addComp(buttonP, connGmailBut, 0, 2, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.NONE,5);
		addComp(buttonP, selContFile, 0, 3, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.NONE,5);
	...
	private void configButtons() {
		connGmailBut = new JButton();
		connGmailBut.setPreferredSize(new Dimension(150, 20));
		connGmailBut.setText(Const.bConGmail);
		connGmailBut.addActionListener(e -> openConnGmail());
	...
	private void openConnGmail() {
		ConnectGmailJFrame conGmail = new ConnectGmailJFrame();
	}
